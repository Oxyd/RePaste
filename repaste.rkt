...
(define handlers
  `((#px"pastebin\\.com/(?:raw/)?(\\w+)"
    ...
    (#px"paste\\.centos\\.org/view/raw/([a-zA-Z0-9]+)" . ,(make-simple-handler "https://paste.centos.org/view/raw/~a"))
    ...
    (#px"pastie\\.org/p/([a-zA-Z0-9]+)" . ,(make-simple-handler "http://pastie.org/p/~a/raw"))
